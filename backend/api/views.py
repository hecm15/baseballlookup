...
managers_annotated = Players.objects.filter(playerid__in=Managers.objects.values('playerid')).annotate(fullname=Concat('namefirst', Value(' ') ,'namelast', output_field=TextField()))
